<?php
App::uses('AparnicSlidersController', 'AparnicSlider.Controller');

/**
 * AparnicSlidersController Test Case
 *
 */
class AparnicSlidersControllerTest extends ControllerTestCase {
