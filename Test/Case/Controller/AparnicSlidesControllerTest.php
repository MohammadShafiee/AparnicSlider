<?php
App::uses('AparnicSlidesController', 'AparnicSlider.Controller');

/**
 * AparnicSlidesController Test Case
 *
 */
class AparnicSlidesControllerTest extends ControllerTestCase {
