...
class AparnicSlidersController extends AparnicSliderAppController {
    ...
    public function admin_add() {
        if ($this->request->is('post')) {
            ...
            if ($this->AparnicSlider->saveWithMeta($this->request->data)) {
                $this->Session->setFlash(__d('aparnic_slider', 'The aparnic slider has been saved'), 'default', array('class' => 'success'));
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(__d('aparnic_slider', 'The aparnic slider could not be saved. Please, try again.'), 'default', array('class' => 'error'));
            }
        }
    }
    ...
    public function admin_delete($id = null) {
        ...
        if ($this->AparnicSlider->delete()) {
            $this->Session->setFlash(__d('aparnic_slider', 'Aparnic slider deleted'), 'default', array('class' => 'success'));
            $this->redirect(array('action' => 'index'));
        }
        $this->Session->setFlash(__d('aparnic_slider', 'Aparnic slider was not deleted'), 'default', array('class' => 'error'));
        $this->redirect(array('action' => 'index'));
    }
